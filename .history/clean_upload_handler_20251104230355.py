...
Handles Excel file uploads (.xlsx, .xls) with batch processing support
Focused on Excel spreadsheet processing for PDS data
"""
...
class CleanUploadHandler:
    """
    Clean file upload handler focused on Excel files (.xlsx, .xls)
    Supports bulk uploads with preview generation for PDS processing
    """
