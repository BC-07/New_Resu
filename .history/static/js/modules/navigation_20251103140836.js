...
const NavigationModule = {
    ...
    loadInitialSection() {
        const hash = window.location.hash.slice(1);
        let initialSection = hash || 'dashboard';
        
        // Clean up any malformed hash values
        initialSection = initialSection.toLowerCase().trim();
        
        // Remove any query parameters or extra characters
        initialSection = initialSection.split('?')[0].split('&')[0];
