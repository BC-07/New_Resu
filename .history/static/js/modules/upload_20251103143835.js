...
const UploadModule = {
    ...
    init() {
        ...
        if (this.isInitialized) {
            console.log('⚠️ UploadModule already initialized, skipping...');
            return;
        }
    ...
    async loadJobPostings() {
        ...
        try {
            ...
            if (jobPostings && jobPostings.length > 0) {
                ...
                console.warn('No job postings available');
            ...
            if (typeof ToastUtils !== 'undefined') {
                ToastUtils.showError('Failed to load job postings. Please refresh the page.');
            }
