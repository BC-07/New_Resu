...
const UploadModule = {
    ...
    calculateResultsAnalytics(results) {
        ...
        // Use actual processing time if available, otherwise estimate
        let processingTime = 0;
        if (results.length > 0 && results[0].processing_time !== undefined) {
            // Sum up individual processing times
            ...
            // Fallback estimate
            processingTime = Math.round(results.length * 0.8 + Math.random() * 2);
        }
