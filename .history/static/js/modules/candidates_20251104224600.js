...
const CandidatesModule = {
    ...
    clearAllLoadingStates() {
        ...
        const loadingContainers = this.candidatesContent.querySelectorAll(
            '.candidates-loading-container, .candidates-refresh-overlay, .candidates-loading-overlay, [data-loading-type]'
        );
        ...
        // Also remove any Bootstrap loading indicators
        const bootstrapLoaders = this.candidatesContent.querySelectorAll('.spinner-border, .loading-state');
        bootstrapLoaders.forEach(loader => {
            if (loader && loader.parentNode === this.candidatesContent) {
