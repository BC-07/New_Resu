...
const CandidatesModule = {
    ...
    setLoadingState(isLoading) {
        ...
        if (this.candidatesContent) {
            if (isLoading) {
                // Only show loading spinner if no data is currently displayed
                if (!this.candidatesData || Object.keys(this.candidatesData).length === 0) {
                    ...
                    // If data exists, show a subtle loading indicator instead
                    let loadingIndicator = document.querySelector('.candidates-loading-overlay');
                    if (!loadingIndicator) {
                ...
                const loadingIndicator = document.querySelector('.candidates-loading-overlay');
                if (loadingIndicator) {
