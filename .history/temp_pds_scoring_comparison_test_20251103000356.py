    ...
    def calculate_score(self, pds_data: Dict, job_data: Dict) -> Dict:
        ...
        try:
            ...
            return {
                ...
                'education_score': assessment_details.get('education_score', 0),
                'experience_score': assessment_details.get('experience_score', 0),
                'training_score': assessment_details.get('training_score', 0),
                'eligibility_score': assessment_details.get('eligibility_score', 0),
